...
import ColumItem from '../../component/ColumnItem';
import ColumnItemTwo from '../../component/ColumnItemTwo';
import './index.css';
...
function ItemTwos (props) {
    ...
    const listItems = array.map((number,key) =>
        // 又对啦！key应该在数组的上下文中被指定
        <ColumnItemTwo key={key} data={number} />
    );
    return (
        <ul className="item clearfix">{listItems}
        </ul>
    );
}
